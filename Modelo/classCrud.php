...
{   
    ...
    public function Select($request,$nameTable,$campoPK, $valorPK, $consultaInner, $datoTablaB,$tablas)
    {
        ...
        if($this->consultaInner != null && $this->valuePKs==NULL)
        {
            //Join
            $joins = '';
        ...
        elseif($this->consultaInner !== null && $this->valuePKs!=NULL)
        {
            //Se debe ejecutar por default
            $this->selectConsult = 'SELECT ' . $this->nameTable . '. *, ' . $this->datoTablaB . ' FROM ' . $this->nameTable
            . ' ' . $this->consultaInner . ' WHERE ' . $this->campoPKs . ' = "' . $this->valuePKs . '"' ; 
        }
        ...
        public function Update($campos, $valores, $tabla, $campoPK, $valorPK)
        {
            ...
            $setValues = []; // Arreglo para guardar los datos de cierta manera
            ...
            // Cierra la conexión correctamente usando mysqli_close
